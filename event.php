...
if($name == null or $date== null or $address==null ){
...
$sql = "INSERT INTO archi.event (nom,date,adress)
VALUES ('$name','$date','$address');";


if ($conn->query($sql)) {
    echo "l'event a bien été ajouté <br>";
} else {
...
mysqli_close($conn);
 ...
 <form action="event.html">
  <input type="submit" value= "Retour sur le formulaire de creation"/>
 </form>
 <form action="resultat.php">
  <input type="submit" value= "voir tous les events"/>
 </form>
</body>
</html>
